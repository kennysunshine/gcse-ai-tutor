                    ...
                    <div className="hidden md:flex items-center gap-6 text-sm font-medium">
                        {!isLoggedIn ? (
                            <>
                                ...
                                <Link href="/library" className="transition-colors hover:text-primary flex items-center gap-1"><span>📚</span> Library</Link>
                            ...
                            <>
                                ...
                                <Link href="/library" className="transition-colors hover:text-primary flex items-center gap-1">
                                    <span>📚</span> Sovereign Library
                                </Link>
                                {isPremium && (
                    ...
                    <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
                        {!isLoggedIn ? (
                            <>
                                ...
                                <Link href="/library" className="text-lg font-medium p-2 hover:bg-muted rounded-md flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}><span>📚</span> Library</Link>
                            ...
                            <>
                                ...
                                <Link href="/library" className="text-lg font-medium p-2 hover:bg-muted rounded-md flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
                                    <span>📚</span> Sovereign Library
                                </Link>
                                {isPremium && (
