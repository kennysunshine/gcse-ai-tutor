...
async function run() {
    console.log("🚀 Starting Targeted RAG Ingestion Pipeline for English...");
    const dirPath = './curriculum_data';

    // specifically target just the two english ones
    const files = [
        'aqa-gcse-english-language-8700.md',
        'aqa-gcse-english-lit-8702.md'
    ];
