...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen font-sans">
      ...
      {/* Pricing Section (Maintained from previous build, updated aesthetics) */}
      < section className="py-32 bg-background relative overflow-hidden" >
        <div className="container px-4 mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium">Choose your tier. Every Elite subscription funds two Foundry Scholarships for disadvantaged students.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="flex flex-col relative border-2 border-slate-100 dark:border-slate-800 shadow-md rounded-[2.5rem] bg-white dark:bg-card">
              <CardHeader className="text-center pb-2 pt-10 px-8">
                ...
                <div className="text-5xl font-extrabold mt-6">£4.99<span className="text-lg text-muted-foreground font-medium">/mo</span></div>
            ...
            <Card className="flex flex-col relative border-0 shadow-2xl scale-105 z-20 bg-primary text-primary-foreground rounded-[2.5rem] overflow-hidden">
              ...
              <CardHeader className="text-center pb-2 pt-16 px-8">
                ...
                <div className="text-5xl font-extrabold mt-6">£24.99<span className="text-lg text-primary-foreground/70 font-medium">/mo</span></div>
              ...
              <CardContent className="flex flex-col flex-grow text-center pt-8 px-8 pb-10">
                ...
                <div className="mt-auto">
                  <CheckoutButton tier="elite" priceAmount={2499} className="w-full rounded-full py-7 text-md font-bold bg-white text-primary hover:bg-slate-100 shadow-xl hover:-translate-y-1 transition-all">Upgrade to Elite</CheckoutButton>
                </div>
              </CardContent>
            </Card>
